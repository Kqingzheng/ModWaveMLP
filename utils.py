...
class MetricsCallback(tf.keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        prediction_val = self.model.predict({"history": self.validation_data["x"][...,0], 
                                             ...
                                             "day_in_week": self.validation_data["x"][...,2],
                                             "wt1": self.validation_data["x"][...,3],
                                             "wt2": self.validation_data["x"][...,4],
                                             "wt3": self.validation_data["x"][...,5],
                                             "wt4": self.validation_data["x"][...,6],})
        ...
        prediction_test = self.model.predict({"history": self.test_data["x"][...,0], 
                                              ...
                                              "day_in_week": self.test_data["x"][...,2],
                                              "wt1": self.test_data["x"][..., 3],
                                              "wt2": self.test_data["x"][..., 4],
                                              "wt3": self.test_data["x"][..., 5],
                                              "wt4": self.test_data["x"][..., 6],
                                              })
